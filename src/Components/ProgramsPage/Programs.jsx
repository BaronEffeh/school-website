...
const programs = [
   ...
   {
      title: 'Information Comunication Technology (ICT)',
      description: 'Our ICT program equips students with essential skills in computer science, programming, and digital literacy. Students will learn to develop software, manage databases, and understand the fundamentals of cybersecurity.',
      image: ICTImage,
      popularity: 10,
